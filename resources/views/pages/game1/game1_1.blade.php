        ...
        <div class="row">
            <div class="col-sm-9 col-xs-12">
                <div class="row">
                    ...
                    <div class="col-6 f " style="color:red; text-align: center; " id=" {{ $tv['id'] }}">
                        <img 
    ...
    $(".f > img").click(function() {
        ...
        function checkTotal() {
            ...
            if ($("input[name=isTotal]").val() == 1) {
                ...
                swal({
                    title: "Finish!",
                    text: "Number of correct sentences: " +countResult  ,
                    type: "success",
                });
                ...
                if (arr_Answer) {
                    ...
                    if(arr_Answer[i].result == 1){
                        resultTrue.append(
                            `<div class="item row">
                        <div class="item__image col-md-4">
                            <img src="${arr_Answer[i].image}" alt="">
                        </div>
                    ...
                    //         `<div class="item row">
                    //     <div class="item__image col-md-4">
                    //         <img src="${arr_resultTrue[i].image}" alt="">
                    //     </div>
                    //     <div class="item__word col-md-3">${arr_resultTrue[i].word}</div>
                    
                    //     <audio  class="item__audio  col-md-5"  controls>
                    //         <source src="${arr_resultTrue[i].audio}" type="audio/ogg">
